/* =========================================================
   ...
   Replaces the localStorage-only persistence for daily attendance
   and leave applications with proper backend tables.

   Tables:
     dbo.StaffAttendance     — one row per (staff, date), upserted
     dbo.StaffLeaveRequests  — one row per leave application
   ========================================================= */

/* ---------------------------------------------------------
   1. StaffAttendance — daily attendance log
   --------------------------------------------------------- */
...
-- One attendance row per staff per date
...
/* ---------------------------------------------------------
   2. StaffLeaveRequests — leave applications
   --------------------------------------------------------- */
